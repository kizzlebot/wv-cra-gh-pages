 ...
 */
const initCreator = (name) => async ({ instance, tools, header }) => {
...
const registerTool = ({
  ...
  buttonName,
  tooltip
}) => async ({ instance, tools, header, toolObject, annotClass }) => {
...
import _ from 'lodash';
import importXfdf from '../importXfdf';
