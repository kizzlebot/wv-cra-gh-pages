...
import registerAnnotationType from './registerAnnotationType';
import registerTool from './registerTool';
import { toHeaderGroup, injectToolArr } from './injectors';
 ...
 */
const initRectAnnot = (name, ogClassName) => async ({ instance, tools, header, ...rest }) => {
...
const initApplySigCreator = (name) => async ({ instance, tools, header, ...rest }) => {
...
export const registerFormFieldTools = R.pipeP(
  createSignatureTool,
  createInitialsTool,
  createApplySigFieldTool,
  toHeaderGroup('formFieldTools')
);

export const registerTemplateTools = R.pipeP(
  createSigTemplateTool,
  createInitialsTemplateTool,
  createAddressTemplateTool,
  toHeaderGroup('templateTools')
);
